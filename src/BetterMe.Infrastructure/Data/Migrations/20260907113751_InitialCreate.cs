...
namespace BetterMe.Infrastructure.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PsychologistId = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_check_ins_users_PatientId",
                        column: x => x.PatientId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_check_ins_users_PsychologistId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_mood_entries_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentChallenges = table.Column<string>(type: "text", nullable: false),
                    PreferredResourceTypes = table.Column<string>(type: "text", nullable: false),
                    SleepQuality = table.Column<int>(type: "integer", nullable: false),
                    StressLevel = table.Column<int>(type: "integer", nullable: false),
                    HasPreviousTherapy = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_onboarding_responses_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PsychologistNotes = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_sessions_users_PsychologistId",
                        column: x => x.PsychologistId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_resource_tag_mappings", x => new { x.ResourceId, x.TagId });
                    table.ForeignKey(
                        name: "FK_resource_tag_mappings_resource_tags_TagId",
                        column: x => x.TagId,
                        principalTable: "resource_tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_resource_tag_mappings_resources_ResourceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_check_ins_PatientId",
                table: "check_ins",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_check_ins_PsychologistId",
                table: "check_ins",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_onboarding_responses_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_resource_tag_mappings_TagId",
                table: "resource_tag_mappings",
                column: "TagId");
